package br.com.passella.pagamento.error.handler;


import br.com.passella.pagamento.error.ApiError;
import br.com.passella.pagamento.error.ApiErrorRequest;
import br.com.passella.pagamento.error.exception.MongoDBNotFoundException;
import br.com.passella.pagamento.kafka.DeadLetterService;
...
public class CustomRestExceptionHandler extends ResponseEntityExceptionHandler implements WebExceptionHandler {
    ...
    public Mono<ResponseEntity<Object>> handlePostgreSQLNotFoundException(final MongoDBNotFoundException ex, final ServerWebExchange exchange) {
        logger.log(Level.SEVERE, ex.toString(), ex);
